...
def frame3():
    ...
    #button widget
    button = QPushButton('PLAY ONCE AGAIN')
    button.setStyleSheet(
        "*{background:'blue'; padding:25px 0px; border: 1px solid 'cyan'; color: 'white'; font-family: 'Arial'; font-size: 25px; border-radius: 40px; margin: 10px 300px;} *:hover{background:'sky blue';}"
        )
    button.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
